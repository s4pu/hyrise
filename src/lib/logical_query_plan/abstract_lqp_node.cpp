...
// currently hash without expressions
size_t AbstractLQPNode::hash_without_values() const {
  size_t hash{0};
...
size_t AbstractLQPNode::_shallow_hash_without_values() const {
  return _shallow_hash();  
}
